...
def on_mouse_release(event):
    ...
    print(f"Frame selected: Xmin={x_min}, Ymin={y_min}, Xmax={x_max}, Ymax={y_max}")
...
def add_exit_button(root):
    confirm_button = tk.Button(root, text="Confirm Selection", command=root.quit)
